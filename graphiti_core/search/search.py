    ...
    with _trace_phase(
        ...
        with _trace_phase(
            ...
            if (
                ...
                search_result_uuids = [[edge.uuid for edge in result] for result in search_results]
                # RRF and cross-encoder scores are different domains. Build the candidate
                # shortlist without the cross-encoder threshold, then apply that threshold
                # only to the cross-encoder scores below.
